...
LOG_ROOT = Path("/root/RL_finalproject/log")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ra_name", type=str, default="ra_latest.pt")
...
def _run(args):
    ...
    if args.testRA:
        ...
        if rec_ckpt is None:
            raise FileNotFoundError("No recovery checkpoint found in /root/RL_finalproject/log.")
