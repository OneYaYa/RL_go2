...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ra_name", type=str, default="04_20_11-37-46_model_4000_ra.pt") #ra_latest.pt, 04_20_11-37-46_model_4000_ra.pt
...
def _run(args):
    ...
    if args.testRA:
        ...
        if rec_ckpt is None:
            raise FileNotFoundError("No recovery checkpoint found in /home/rex/Desktop/github/finalprojectRL/RL_finalproject/log.")
        ...
        for i in range(total_steps):
            ...
            if args.testRA and recovery_policy is not None:
                with torch.no_grad():
                    ...
                    use_recovery = ra_score > args.ra_threshold
                    print(f"The usage of recovery is {ra_score > args.ra_threshold}")
                if use_recovery.any():
                    with torch.no_grad():
                        rec_actions = recovery_policy(obs, obs_tensor)
